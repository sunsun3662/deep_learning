...
\begin{titlepage}
    ...
    \vspace{20mm}
		\textbf{\huge\textbf{\kaishu{xxx学院}}}\\[0.5cm]
		\textbf{\huge{\kaishu{深度学习及应用（高阶课） 实验报告}}}\\[2.3cm]
		\textbf{\Huge\textbf{\kaishu{生成对抗网络（GAN）算法}}}
    ...
    % \HRule \\[2.0cm]
    \centering
    \textsc{\LARGE \kaishu{姓名\ :\ xxx}}\\[0.5cm]
    \textsc{\LARGE \kaishu{学号\ :\ xxxxxxxxx}}\\[0.5cm]
...
\begin{lstlisting}[title=判别器和生成器定义,frame=trbl,language={Python}]
import torch
...
\begin{lstlisting}[title=GAN训练函数,frame=trbl,language={Python}]
...
\begin{lstlisting}[title=主实验代码,frame=trbl,language={Python}]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{outputs/experiment_comparison.png}
...
\centering
\includegraphics[width=2.5in]{outputs/adam_lr0.0002_epoch9.png}
\label{fig:adam0002}
\end{minipage}%
}%
...
\begin{minipage}[t]{0.33\linewidth}
\centering
\includegraphics[width=2.5in]{outputs/sgd_lr0.03_epoch9.png}
\label{fig:sgd003}
\end{minipage}%
}%
...
\begin{minipage}[t]{0.33\linewidth}
\centering
\includegraphics[width=2.5in]{outputs/adam_lr0.001_epoch9.png}
\label{fig:adam001}
\end{minipage}%
}%
\centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{outputs/epoch_progression.png}
